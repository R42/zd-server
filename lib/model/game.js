...
Model.prototype.hasWonVP = function() { return this.brains.length + this.score >= 13; };
Model.prototype.isShotgunned = function() { return this.shots.length >= 3; };

Model.prototype.checkRolled = function() {
  if (!this.hasWonVP() && !this.isShotgunned())
    return;
